...
#define ADC_SAR_IP_SW_MAJOR_VERSION_PBCFG_C              5
...
/**
* @brief          ADC SAR Ip List of Channels Configuration for Logical ID 0 corresponding to the ADC1 configuration variant  .
*/
...
/**
* @brief          ADC SAR Ip Config for Logical ID 0 corresponding to the ADC1 configuration variant  .
*/
