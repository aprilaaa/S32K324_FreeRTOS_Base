...
/**
* @brief          Symbolic name for the channel DioChannel_LEDR.
*
*/
#define DioConf_DioChannel_DioChannel_LEDR  ((uint16)0x001dU)
/**
* @brief          Symbolic name for the channel DioChannel_LEDG.
*
*/
#define DioConf_DioChannel_DioChannel_LEDG  ((uint16)0x001eU)
/**
* @brief          Symbolic name for the channel DioChannel_LEDB.
*
*/
