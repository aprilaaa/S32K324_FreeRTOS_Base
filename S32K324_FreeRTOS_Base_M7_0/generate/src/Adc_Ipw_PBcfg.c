...
const Adc_Ipw_Config AdcIpwCfg =
{
    ...
    { 1U, ADC_IPW_INVALID_LOGICAL_UNIT_ID, ADC_IPW_INVALID_LOGICAL_UNIT_ID }, /* AdcPhysicalIdArr */
    ...
    /* Mapping */
    {
        ...
        { ADC_IPW_INVALID_LOGICAL_UNIT_ID, 0U, ADC_IPW_INVALID_LOGICAL_UNIT_ID }, /* HwLogicalId */
