...
#define ADC_SW_MAJOR_VERSION_PBCFG_C             5
...
*
*/
static const Adc_ChannelType Adc_Group0_Assignment_1[ADC_CFGSET_GROUP_0_CHANNELS] =
{
    0U
};
...
static const Adc_GroupConfigurationType Adc_GroupsCfg[] =
{
    /**< @brief Group0 -- Logical Unit Id 0 -- Hardware Unit ADC1 */
    {
        ...
        Adc_Group0_Assignment_1, /* AssignmentPtr */
